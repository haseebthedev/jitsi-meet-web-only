...
interface IProps extends AbstractProps {
    ...
    /**
     * Whether the current user is a moderator or not.
     */
    ...
    function renderChat() {
        ...
        return (
            <>
                ...
                >
                    {_isUserModerator && (
                        <div className={cx(classes.switchContainer)}>
                            <div>Turn ON / OFF Chat for Students</div>

                            <Switch
                                isChecked={_isChatOpenForOthers}
                                onChange={(value: boolean) => onSendMessage(value ? "ENABLE_CHAT" : "DISABLE_CHAT")}
                            />
                        </div>
                    )}
